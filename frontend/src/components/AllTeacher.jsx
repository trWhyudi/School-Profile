    ...
    return (
      <div className="bg-sky-50 py-20">
        <div className="max-w-[1440px] mx-auto px-4" data-aos="fade-up">
          <h1 className="text-3xl md:text-4xl font-bold text-sky-600 text-center mb-3">
            Kenali Guru Kami
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-12 text-center">
            Profil Para Guru Profesional yang Berdedikasi dalam Mendidik,
            Membimbing, dan Menginspirasi Siswa Menuju Masa Depan Gemilang
          </p>
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl font-semibold text-gray-700">
                          {teacher[0]?.userId?.name || "Nama Guru"}
                        </h2>
                        <p className="text-sm text-gray-600 capitalize flex items-center gap-2">
                          <FaBook className="text-sky-600" /> Mata Pelajaran:{" "}
                          {teacher[0]?.subject}
                        </p>
                        <p className="text-sm text-gray-600 capitalize flex items-center gap-2">
                          <FaBuilding className="text-sky-600" /> Jurusan:{" "}
                          <span>{teacher[0]?.department}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <h2 className="text-xl md:text-2xl font-semibold text-gray-700">
                            {teacherItem?.userId?.name || "Nama Guru"}
                          </h2>
                          <p className="text-sm text-gray-600 flex items-center gap-2 md:text-md">
                            <FaBook className="text-sky-600 " /> Mata Pelajaran:{" "}
                            {teacherItem?.subject}
                          </p>
                          <p className="text-sm md:text-md text-gray-600 capitalize flex items-center gap-2">
                            <FaBuilding className="text-sky-600" /> Jurusan:{" "}
                            <span>{teacherItem?.department}</span>
                          </p>
                        </div>
                      </div>
                    </div>
