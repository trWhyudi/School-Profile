...
const SchoolGallery = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-r from-sky-50 to-indigo-200 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1440px] mx-auto" data-aos="fade-up">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-12 text-center">
            Kumpulan Momen Berharga, Kegiatan Seru, dan Suasana Pembelajaran di
            Sekolah Kami
          </p>
